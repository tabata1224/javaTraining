 ...
 * int m_defense 【処理内容】引数で取得した値をスーパークラスのコンストラクタに引き渡す。typeは"勇者"を指定。
 * 
 * 【メソッド名】コンストラクタ 【引数】なし 【処理内容】 値をスーパークラスのコンストラクタに引き渡す。値は以下を参考にすること。 name="ななし ひろ", level=1, hp=10,
 * mp=8, attack=10, m_attack=8, defense=8, m_defense=7, type="勇者"
 * 
