 ...
 * 
 * 【メソッド名】param01 【戻り値】void 【引数】int x 【処理内容】「x + "を受け取りました"」を表示する
 * 
 * 【メソッド名】param02 【戻り値】void 【引数】double x 【処理内容】「x + "を受け取りました"」を表示する
 * 
 * 【メソッド名】param03 【戻り値】void 【引数】String x 【処理内容】「x + "を受け取りました"」を表示する
 */
